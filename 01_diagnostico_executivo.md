...
| **Atendimento** | Um único tipo de chamado — "onde está meu pedido" — responde por 30% de todo o volume de atendimento, com cerca de 68 chamados por semana | O canal automatizado já entrega satisfação comparável à do atendimento humano por uma fração do custo — mas o dado disponível mostra apenas por onde o chamado entrou, não se foi resolvido sem intervenção humana; ainda não há um sinal medido de contenção real | Entre R$ 23 mil e R$ 41 mil por ano, dependendo do quanto puder ser automatizado com segurança |
